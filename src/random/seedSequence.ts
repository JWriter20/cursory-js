...
export function intToUint32Array(value: bigint): number[] {
  if (value < 0n) {
...
export function mixEntropy(entropy: readonly number[]): Uint32Array {
...
export function generateState64(pool: Uint32Array, wordCount: number): BigUint64Array {
